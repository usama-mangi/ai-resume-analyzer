...
import { OFFER_STATUS_CONFIG } from "~/lib/status-config";

export const meta = () => [
  { title: "Career Autopilot | Offers" },
...
function StatusBadge({ status }: { status: string }) {
  const config = OFFER_STATUS_CONFIG[status as keyof typeof OFFER_STATUS_CONFIG] || { label: status, color: "text-gray-600", bgColor: "bg-gray-100", borderColor: "border-gray-200" };
  return (
