...
export function Sidebar({ collapsed = false, onToggle }: SidebarProps) {
  ...
  if (collapsed) {
    return (
      <aside className="fixed inset-y-0 left-0 z-40 w-[68px] bg-white border-r border-gray-200 flex flex-col items-center py-4 gap-2">
        <Link to="/dashboard" className="mb-4 flex items-center justify-center w-9 h-9 rounded-lg bg-primary-500 text-white text-xs font-bold">
          CA
        </Link>
