    ...
    <Fragment>
      ...
      >
        <div
          ...
          tabIndex={-1}
          className={cn(
            "w-full bg-white rounded-2xl shadow-xl border border-gray-200",
            sizeClasses[size],
...
export function ModalFooter({ actions, className }: ModalFooterProps) {
  return (
    <div
      className={cn(
        "flex items-center justify-end gap-3 p-6 border-t border-gray-100 bg-gray-50/50 rounded-b-2xl",
        className,
      )}
    >
