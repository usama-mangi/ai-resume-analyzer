    ...
    <PageShell maxWidth="full" padding="lg">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Find opportunities across LinkedIn, Indeed, Glassdoor, and company
          career pages
        </p>
      </div>
            ...
            loadingBookmarked ? (
              ...
              <Card className="text-center py-16">
                ...
                <p className="text-sm text-gray-500">
                  Enter keywords and location to find opportunities
                </p>
              </Card>
            )
        ...
        <div>
          {loadingBookmarked ? (
            ...
            <Card className="text-center py-16">
              ...
              <p className="text-sm text-gray-500">
                Bookmark jobs from search results to see them here
              </p>
            </Card>
          ) : (
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          {store.resumes.length === 0 ? (
            <Card className="text-center py-16">
              ...
              <p className="text-sm text-gray-500 mb-4">
                AI matching compares your resume against job descriptions
              </p>
              <Button
                variant="secondary"
            ...
            <Card className="text-center py-16">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Search for jobs first, then switch to this tab to see AI match
                scores
              </p>
              <Button
                variant="secondary"
...
function JobCard({
  ...
  return (
    <Link to={`/jobs/${job.id}`} className="block group">
      <div className="h-full border border-gray-200 border-l-[3px] rounded-xl p-4 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 bg-white" style={{ borderLeftColor: sourceStyle.color }}>
        {/* Top row: source + posted date */}
        <div className="flex items-center justify-between mb-2.5">
          <span
            className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[11px] font-semibold uppercase tracking-wide ${sourceStyle.bg} ${sourceStyle.text}`}
          >
        ...
        {/* Title */}
        <h3 className="text-[15px] font-semibold text-gray-900 leading-snug mb-1 line-clamp-2 group-hover:text-primary-600 transition-colors">
          {job.title}
        </h3>
        ...
        {(job.seniorityLevel || job.jobFunction) && (
          <div className="flex items-center gap-1.5 mb-2.5 flex-wrap">
            {job.seniorityLevel && (
              <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold bg-purple-50 text-purple-700 capitalize">
                {job.seniorityLevel}
              </span>
            )}
            {job.jobFunction && (
              <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold bg-sky-50 text-sky-700 capitalize">
                {job.jobFunction}
              </span>
            )}
          </div>
