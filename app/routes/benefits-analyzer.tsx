          ...
          {!result ? (
            ...
            <div className="space-y-6">
              ...
              {result.totalCompensationValue > 0 && (
                <Card className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 p-6 text-center">
                  <div className="text-sm text-indigo-600 mb-1">Estimated Benefits Value</div>
                  <div className="text-3xl font-bold text-indigo-900">{formatMoney(result.totalCompensationValue)}/yr</div>
                </Card>
              )}
